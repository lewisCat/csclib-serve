...
public class SysuserController {
  ...
  @Autowired ISysuserService service;

  @CrossOrigin
  @ApiOperation("新增系统用户")
  @PostMapping("/add")
  public boolean add(Sysuser newSysuser) {
  ...
  @PostMapping("/login")
  public Sysuser login(Sysuser logSysuser) {
  ...
  @ApiOperation("系统用户修改")
  @PostMapping("/modify")
  public boolean modify(@NotNull Sysuser user) {
